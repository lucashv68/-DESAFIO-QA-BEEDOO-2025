...
Criação dos cenários e casos de teste manuais

Execução dos testes e registro de evidências
...
- **Base de informação:** A user story foi criada com base na tela e nas funcionalidades observadas no módulo “Cadastrar Curso” da aplicação Beedoo Challenge.  
- **Critérios de aceite:** Definidos de acordo com o comportamento esperado da interface — preenchimento de campos obrigatórios, feedback visual e redirecionamento após o cadastro.  
